...
const botonCompra = document.querySelector("#boton-carrito-comprar")
            ...
            const div = document.createElement("div");
                ...
                div.innerHTML = `
                    ...
                    <div class="informacion-producto-carrito">
                        <small>Titulo</small>
                        <h3 class="h3">${productos.titulo}</h3>
                    </div>
                    ...
                    <button class="eliminar-producto-carrito buttons" id="${productos.id}" ><i class="bi bi-trash"></i></button>`
...
function comprar() {
    Swal.fire(
        ...
        'Se debitaran de tu billetera virtual $ ' + actualizarPrecio(),
        'success'
      )
